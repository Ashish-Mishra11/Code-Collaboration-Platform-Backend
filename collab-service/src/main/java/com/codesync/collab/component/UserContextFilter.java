package com.codesync.collab.component;
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (username != null && !username.trim().isEmpty() && role != null && !role.trim().isEmpty()) {
            ...
            if (userIdStr != null && !userIdStr.isEmpty()) {
                authentication.setDetails(userIdStr);
            }

            // Set in SecurityContext
            SecurityContextHolder.getContext().setAuthentication(authentication);

            System.out.println("UserContextFilter: User authenticated → " + username + " (ID: " + userIdStr + ") | Role: " + role);
        } else {
