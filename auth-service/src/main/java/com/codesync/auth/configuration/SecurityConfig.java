package com.codesync.auth.configuration;
...
import com.codesync.auth.component.GitHubOAuthSuccessHandler;
import com.codesync.auth.component.GoogleOAuthSuccessHandler;
import com.codesync.auth.filter.JwtFilter;
        ...
        http.csrf(customizer -> customizer.disable())
                .authorizeHttpRequests(request -> request
                        .requestMatchers(
                                ...
                                // Only the admin login endpoint is public
                                "/api/admin/login",
                        ...
                        .permitAll()
                        // Admin action endpoints require a valid JWT with role=ADMIN
                        .requestMatchers("/api/admin/applications", "/api/admin/approve", "/api/admin/reject")
