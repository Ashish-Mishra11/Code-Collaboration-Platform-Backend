...
public interface ProjectService {
    ...
    CollaboratorDto addCollaborator(Integer projectId, Integer requesterId, Integer collaboratorId);

    void removeCollaborator(Integer projectId, Integer requesterId, Integer collaboratorId);

    List<CollaboratorDto> getCollaborators(Integer projectId);

    /** Returns "OWNER", "COLLABORATOR", or "NONE" */
    String getUserRole(Integer projectId, Integer userId);
